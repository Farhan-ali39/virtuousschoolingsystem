...
// echo $student_id;
// var_dump($student_current_class);
...
public function handle_upload()
    ...
    public function youtubeVideos()
    {
        ...
        $data['title']       = 'Digital Learning';
        $this->load->view('layout/student/header', $data);
        $this->load->view('user/youtube_videos/index', $data);
        $this->load->view('layout/student/footer', $data);
    }
    ...
    {
        $student_current_class = $this->customlib->getStudentCurrentClsSection();
        $data['onlineClass'] =$classSchedule = $this->Classschedule_model->getClassScheduleByClassandSection($student_current_class->class_id, $student_current_class->section_id);
        $data['title']       = 'Online Class';
        $this->load->view('layout/student/header', $data);
        $this->load->view('user/online_classes/online_class', $data);
        $this->load->view('layout/student/footer', $data);
    }
    ...
    {
//        print_r($_FILES);
//        echo $id;//this will print out the received name, temp name, type, size, etc.
//        die();
    ...
    public function getAllComments()
    {
        ...
        $data['currentId']=$this->customlib->getStudentSessionUserID();
    ...
    public function recorded_classes()
    {
        $student_current_class = $this->customlib->getStudentCurrentClsSection();
        $data['onlineClass'] =$classSchedule = $this->Classschedule_model->getClassScheduleByClassandSection($student_current_class->class_id, $student_current_class->section_id);
        $data['title']       = 'Recorded Class';
        $data['class_id']       = $student_current_class->class_id;
        $data['section_id']       = $student_current_class->section_id;
        $this->load->view('layout/student/header', $data);
        $this->load->view('user/online_classes/recorded_classes_list', $data);
        $this->load->view('layout/student/footer', $data);

    }

    public function recorded_class($id=null)
    {
        $student_current_class = $this->customlib->getStudentCurrentClsSection();
        $data['onlineClass'] =$classSchedule = $this->Classschedule_model->get($id);
        $data['title']       = 'Online Class';
        $this->load->view('layout/student/header', $data);
        $this->load->view('user/online_classes/previous_class', $data);
        $this->load->view('layout/student/footer', $data);
