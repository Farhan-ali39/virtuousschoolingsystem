...
class LeaveTypes extends Admin_Controller {
    ...
    function createLeaveType() {
        ...
        if ($this->form_validation->run()) {
            ...
            $include_salary = $this->input->post("include_salary");
            ...
            if (!empty($leavetypeid)) {
                $data = array('type' => $type, 'is_active' => 'yes', 'id' => $leavetypeid,'include_salary'=>$include_salary);
            } else {

                $data = array('type' => $type, 'is_active' => 'yes','include_salary'=>$include_salary);
            }
