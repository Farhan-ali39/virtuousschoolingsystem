                                    ...
                                    <tr>
                                        ...
                                        <td class="pull-right">
                                            <?php if ($this->rbac->hasPrivilege('collect_fees', 'can_add')) { ?>
                                                ...
                                                <a  href="<?php echo base_url(); ?>studentfee/collectFee/<?php echo $student['student_session_id'] ?>" class="btn btn-info btn-xs" data-toggle="tooltip" title="" data-original-title="">
