        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form action="<?php echo site_url('studentfee/stdDiscountsearch') ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
...
<!--                                    <th class="text text-right">--><?php //echo $this->lang->line('fine'); ?><!-- <span>--><?php //echo "(" . $currency_symbol . ")"; ?><!--</span></th>-->
                                ...
                                <?php if (empty($student_due_fee)) {
                                    ...
                                    foreach ($student_due_fee as $student) {
                                        $grandTotalBalance+=$student['amount_detail'];
                                        ...
                                        <tr>
                                            ...
                                            <!--                                            <td>--><?php //echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($student['dob'])); ?><!--</td><td>--><?php //echo date($this->customlib->getSchoolDateFormat(), strtotime($student['due_date'])); ?><!--</td>-->
