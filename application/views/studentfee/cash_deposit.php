                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Bank Deposits</h3>
                        </div><!-- /.box-header -->
                        <form   action="<?php echo site_url('Studentfee/cash_deposit') ?>"  id="bankAmountform" name="bankAmountform" method="post" accept-charset="utf-8">
                            <div class="box-body">
            ...
            ?>">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix">Bank Deposits</h3>
                        <div class="box-tools pull-right">
                        </div><!-- /.box-tools -->
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <div class="mailbox-messages table-responsive">
                            <div class="download_label">Bank Deposits</div>
                            <table class="table table-striped table-bordered table-hover example">
                                ...
                                foreach ($bankAmountLists as $amountList) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="mailbox-name">
                                            <?php echo $amountList->invoice_no ?>
                                        </td>
                                        ...
                                        <td class="mailbox-date pull-right">
                                            ...
                                            if ($this->rbac->hasPrivilege('collect_fees', 'can_delete')) {
                                                ?>
                                                <a data-placement="left" href="<?php echo base_url(); ?>Studentfee/delete_cash_deposit/<?php echo $amountList->main_id ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
