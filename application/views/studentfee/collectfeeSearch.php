                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                <div class="row">
                                    <form role="form" action="<?php echo site_url('studentfee/feeCollectionSearch') ?>" method="post" class="">
                                    ...
                                    <tr>
                                        ...
                                        <td class="pull-right">
                                            <?php if ($this->rbac->hasPrivilege('collect_fees', 'can_add')) { ?>
                                                ...
                                                <a  href="<?php echo base_url(); ?>studentfee/CollectFee/<?php echo $student['id'] ?>" class="btn btn-info btn-xs" data-toggle="tooltip" title="" data-original-title="">
