        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form action="<?php echo site_url('studentfee/stdInstallmentSearch') ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
                                ...
                                <?php if (empty($student_due_fee)) {
                                    ...
                                    $grandTotalDeposit=0;
                                     ...
                                     foreach ($student_due_fee as $student) {
                                        $grandTotalBalance+=$student['payable'];
                                         $grandTotalDeposit+=$student['deposit'];
                                        $grandTotalAmount+=$student['total_amount'];
                                        if($student['total_amount']!=0) {
                                            ...
                                            <tr>
                                                ...
                                                ?><!--</td><td>-->
                                                <?php //echo date($this->customlib->getSchoolDateFormat(), strtotime($student['due_date']));
                                                ?><!--</td>-->

                                                <td class="text text-right"><?php
                                                    echo(number_format($student['total_amount'], 2, '.', ','));
                                                    ?></td>
                                                ...
                                                ?><!--</td>-->
                                                <td class="text text-right"><?php
                                                    echo(number_format($student['payable'], 2, '.', ','));
                                                    ?></td>
                                                <?php

                                                foreach ($monthsLists as $monthsList)
                                                {
                                                    if(isset($student['stdInstallmentByMonth'][$monthsList]))
                                                    {
                                                        echo '<td>'.$student['stdInstallmentByMonth'][$monthsList].'</td>';
                                                ...
                                                <td class="text text-right">
                                                    <?php if ($this->rbac->hasPrivilege('collect_fees', 'can_add')) { ?>
                                                        <a
                                                        href="<?php echo base_url(); ?>studentfee/CollectFee/<?php echo $student['id'] ?>"
                                    ...
                                    <tr>
                                        ...
                                        <td class="text text-right"><?=number_format($grandTotalBalance, 2, '.', ',')?></td>
                                        <?php
