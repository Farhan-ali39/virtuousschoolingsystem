            ...
            if ($this->rbac->hasPrivilege('fees_discount', 'can_add')) {
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo site_url('admin/feediscount/feediscounts') ?>"  id="feediscountform" name="feediscountform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="js-example-basic-multiple form-control" name="feeType" required >
                                        <?php
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('discount')." ";echo $this->lang->line('rate'); ?>(%) </label> <small class="req">*</small>
                                    <input id="amount"  name="amount" type="number"  class="form-control" min="0" step="0.1" value="0"  required/>
                        ...
                        <div class="mailbox-messages table-responsive">
                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                ...
                                <tr>
                                    ...
                                    <th><?php echo $this->lang->line('amount')." "; ?><?php echo $this->lang->line('rate'); ?>(%)
                                    </th>
                                ...
                                foreach ($feediscountList as $feediscount) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="mailbox-name">
                                            <?php echo $feediscount->fee_type_id ?>

                                        </td>

                                        <td class="mailbox-name">
                                            <?php echo $feediscount->discount_rate ?>
                                        </td>
                                        <td class="mailbox-name">
                                            <?php echo $feediscount->date ?>
                                        </td>
                                        ...
                                        <td class="mailbox-date pull-right">
                                            ...
                                            if ($this->rbac->hasPrivilege('fees_discount_assign', 'can_view')) {
                                                ?>
                                                <a data-placement="left" href="<?php echo base_url(); ?>admin/feediscount/assignFeeDiscount/<?php echo $feediscount->discount_id ?>"
                                                   class="btn btn-default btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('assign'); ?>">
                                                    <i class="fa fa-tag"></i>
                                                </a>
                                                <?php
                                            }
...
<!--                                                <a data-placement="left" href="--><?php //echo base_url(); ?><!--admin/feediscount/edit1/--><?php //echo $feediscount->discount_id?><!--" class="btn btn-default btn-xs"  data-toggle="tooltip" title="--><?php //echo $this->lang->line('edit'); ?><!--">-->
...
<!--                                                </a>-->
                                            ...
                                            if ($this->rbac->hasPrivilege('fees_discount', 'can_delete')) {
                                                ?>
                                                <a data-placement="left" href="<?php echo base_url(); ?>admin/feediscount/delete1/<?php echo $feediscount->discount_id?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
