                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Amount Transfer (Bank to Bank) </h3>
                        </div><!-- /.box-header -->
                        <form   action="<?php echo site_url('Studentfee/bank_transfer') ?>"  id="bankAmountform" name="bankAmountform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('bank')." ".$this->lang->line('from'); ?></label> <small class="req">*</small>
                                    <select   id="bank_from" name="bank_from" class="form-control"  >
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('bank')." ".$this->lang->line('to'); ?></label> <small class="req">*</small>
                                    <select   id="bank_to" name="bank_to" class="form-control"  >
                                        <option value="" disabled><?php echo $this->lang->line('select'); ?></option>
                                        <option value="HBL">HBL</option>
                                        <option value="Soneri">Soneri</option>
                                    </select>
                                    ...
                                    <span class="text-danger"><?php echo form_error('bank_to'); ?></span>
                                </div>
            ...
            ?>">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix">Bank Transfers</h3>
                        <div class="box-tools pull-right">
                        </div><!-- /.box-tools -->
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <div class="mailbox-messages table-responsive">
                            <div class="download_label">Bank Transfers</div>
                            <table class="table table-striped table-bordered table-hover example">
                                <thead>
                                <tr>

                                    <th><?php echo $this->lang->line('bank')." ".$this->lang->line('from'); ?>
                                    <th><?php echo $this->lang->line('bank')." ".$this->lang->line('to'); ?>
                                ...
                                foreach ($bankAmountLists as $amountList) {
                                    ...
                                    <tr>
                                        <td class="mailbox-name">
                                            <a href="#" data-toggle="popover" class="detail_popover"><?php echo $amountList->bank_from ?></a>
                                        ...
                                        <td class="mailbox-date pull-right">
                                            <?php
                                             if ($this->rbac->hasPrivilege('collect_fees', 'can_delete')) {
                                                ?>
                                                <a data-placement="left" href="<?php echo base_url(); ?>Studentfee/delete_bank_transfer/<?php echo $amountList->transfer_id ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
