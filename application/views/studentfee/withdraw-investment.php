                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Withdraw/Investment</h3>
                        </div><!-- /.box-header -->
                        <form   action="<?php echo site_url('Studentfee/withdraw') ?>"  id="bankAmountform" name="bankAmountform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('payment')." ".$this->lang->line('mode'); ?></label> <small class="req">*</small>
            ...
            ?>">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix">Withdraw/Investment details</h3>
                        <div class="box-tools pull-right">
                        </div><!-- /.box-tools -->
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <div class="mailbox-messages table-responsive">
                            <div class="download_label">Withdraw/Investment details</div>
                            <table class="table table-striped table-bordered table-hover example">
                                <thead>
                                <tr>

                                    <th><?php echo $this->lang->line('payment')." ".$this->lang->line('mode'); ?>
                                ...
                                foreach ($bankAmountLists as $amountList) {
                                    ...
                                    <tr>
                                        <td class="mailbox-name">
                                            <a href="#" data-toggle="popover" class="detail_popover"><?php echo $amountList->mode ?></a>
                                        ...
                                        <td class="mailbox-date pull-right">
                                            ...
                                            if ($this->rbac->hasPrivilege('collect_fees', 'can_delete')) {
                                                ?>
                                                <a data-placement="left" href="<?php echo base_url(); ?>Studentfee/delete_withdraw/<?php echo $amountList->main_id ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
