                            ...
                            <div class="form-bottom">
                                ...
                                <form action="<?php echo site_url('site/userlogin') ?>" method="post">
                                    ...
                                    <div class="form-group has-feedback">
                                        ...
                                        <input type="text"  name="username" placeholder="<?php echo $this->lang->line('username'); ?>" class="form-username form-control userlogin-input" id="email">
                                        <span class="fa fa-envelope form-control-feedback"></span>
                                        <span class="text-danger"><?php echo form_error('username'); ?></span>
                                    </div>
                                    <div class="form-group has-feedback">                                        
                                        <input type="password" name="password" placeholder="<?php echo $this->lang->line('password'); ?>" class="form-password form-control userlogin-input" id="password">
                                    ...
                                    <a href="<?=base_url('Online-Admission')?>" class="btn" style="margin-top: 5px;color: red;font-size: 20px;font-weight: bold;">Online Admission</a>
                                </form>
