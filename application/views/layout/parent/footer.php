...
<div class="footer fixed_footer " id="mydiv"   style="z-index: 1" align="center">
    <ul class="list-inline dropdown"  >
        ...
        <li class="list-inline-item   "> <a href="<?=base_url('parent/parents/FacebookProfile')?>" > <i class="fa fa-facebook-official fa-2x circle-icon  mt10"></i> <br> facebook </a>  </li>
        ...
        if ($this->parentmodule_lib->hasActive('attendance')) {
            ?>
            <li class="list-inline-item   "> <a href="<?php echo base_url(); ?>parent/parents/getattendence/<?php echo $main_student_id ?>"> <i class="fa fa-calendar-check-o fa-2x circle-icon   "></i> <br> Attendance   </a>  </li>

            <?php
        }
        if ($this->parentmodule_lib->hasActive('examinations')) {
            ?>
            <li class="list-inline-item   "> <a href="<?=base_url('parent/parents/getexams/').$main_student_id?>"> <i class="fa fa-map-o ftlayer fa-2x circle-icon   "></i> <br>  <span class=" ">Result</span>   </a>  </li>

            <?php
        }
        if ($this->parentmodule_lib->hasActive('download_center')) {
            ?>
            <li class="list-inline-item   "> <a href="<?=base_url('parent/parents/download_docs/').$main_student_id?>"> <i class="fa fa-file-o fa-2x circle-icon  "></i> <br> Assignment</a>  </li>

            <?php
        }
        if ($this->parentmodule_lib->hasActive('homework')) {
            ?>
            <li class="list-inline-item   "> <a href="<?=base_url('parent/homework/student_homework/').$main_student_id?>"> <i class="fa fa-flask ftlayer fa-2x circle-icon  "></i> <br> Homework</a>  </li>

            <?php
        }
        if ($this->parentmodule_lib->hasActive('notice_board')) {
            ?>
            <li class="list-inline-item   "> <a href="<?=base_url('parent/notification')?>"> <i class="fa fa-bullhorn fa-2x circle-icon"></i> <br> <span class="mt5">Notice</span> </a>  </li>
        ...
        if ($this->parentmodule_lib->hasActive('notice_board')) {
            ?>
            <li class="list-inline-item   "> <a href="<?=base_url('parent/notification')?>" > <i class="fa fa-comment-o fa-2x circle-icon mt5"></i> <br>Complain</a>  </li>
