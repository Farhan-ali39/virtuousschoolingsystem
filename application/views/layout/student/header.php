...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url() ?>backend/fullcalendar/dist/fullcalendar.print.min.css" media="print">
            ...
            <script src="<?=base_url('backend/js/userRecoder.js')?>"  ></script>
...
<!--                        </span>-->
                    ...
                    <div class="navbar-custom-menu">
                        ...
                        <ul class="nav navbar-nav headertopmenu">
                            ...
                            <?php }  if ($this->studentmodule_lib->hasActive('chat')){
                                $msgCount = count($this->customlib->mychatnotificationstd());
                                ?>
                                <li class="cal15"><a data-placement="bottom" data-toggle="tooltip" title="" href="<?php echo base_url()?>user/chat" data-original-title="Chat" class="todoicon"><i class="fa fa-whatsapp"></i>
    ...
    <aside class="main-sidebar" id="alert2">
        <section class="sidebar">
            ...
            <!--                        </li>   -->
            <!--                    </ul>                -->
            <ul class="sidebar-menu verttop38" id="sibe-box" style="    padding-top: 15px;">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <ul class="col-md-4 treeview-menu1">
                        ...
                        <li class="info-box  "><a  href="<?=base_url('user/user/digital_learning')?>" > Digital Learning </a></li>
                        <li class="info-box  "><a   href="<?=base_url('user/user/youtubeVideos')?>" >  Poem / Rhymes  </a></li>
                    ...
                    <ul class="col-md-4 treeview-menu1">
                        ...
                        <li class="info-box  "><a href="<?=base_url('user/user/games')?>">    Games</a></li>
                         <li class="info-box  "><a href="<?=base_url('user/user/online_class')?>">    Online Class</a></li>
                    ...
                    <ul class="col-md-4 treeview-menu1">
                        ...
                        <li class="info-box  "><a href="<?=base_url('user/user/recorded_classes')?>">Recorded Classes</a></li>
                    </ul>
