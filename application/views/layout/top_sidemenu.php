<ul class="sessionul fixedmenu">
    <li class="removehover">
        <a   data-toggle="modal" data-target="#sessionModal">  <i class="fa fa-pencil pull-right" style="color: white"></i></a>
    ...
    <li class="dropdown">
            ...
            <a class="dropdown-toggle drop5" data-toggle="dropdown" href="#" aria-expanded="false" style="color: white">
