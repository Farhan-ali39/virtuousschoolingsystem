                        ...
                        <form id="form1" action="<?php echo base_url() ?>admin/exam"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Is Assesment</label><small class="req"> *</small>
                                    <select class="form-control" name="exam_type" id="assesment_type" onchange="change_tye()" >
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="type" id="terms" style="display: none" >
                                        <option value="1">Assessment First</option>
                                        <option value="2">Assessment Second</option>
                                        <option value="4">Assessment Third</option>
                                        <option value="5">Assessment Fourth</option>
                                    </select>
                                    <select class="form-control" name="type" id="mid_term" style="display: none" >
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        var type= $('#assesment_type').val();
        if(type==2)
        {
            $('#mid_term').css('display','block');
            $('#terms').css('display','none');
        }else if(type==1)
        {
            $('#terms').css('display','block');
            $('#mid_term').css('display','none');
