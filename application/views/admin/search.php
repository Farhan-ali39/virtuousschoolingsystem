...
if (!empty($fields)) {
            ...
            ?>
                ...
                ?>
                                                        <a href="<?php echo base_url(); ?>studentfee/CollectFee/<?php echo $student['id'] ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('add_fees'); ?>">
