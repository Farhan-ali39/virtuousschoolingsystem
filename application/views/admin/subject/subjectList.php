                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label class="checkbox-inline">
                                        <input type="checkbox" value="1" name="compare"  <?php if (set_value('compare') == 1){ echo "checked"; } ?>>
...
<!--                                </label><br>-->
                                <br>
                                <label class="radio-inline">
                                    <input type="radio" value="2" name="school_type" onclick="btn_css()" <?php if($school_id==2){echo "checked";} ?>  > Primary & Secondary
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="school_type" onclick="btn_css()" <?php if($school_id==1){echo "checked";} ?> value="1"> Pre-Primary
                                </label>
