                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo site_url('admin/leavetypes/createLeaveType') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                <label for="exampleInputEmail1"><?php echo $this->lang->line('include_salary'); ?></label>
                                <br/>
                                <label class="radio-inline">
                                    <input type="radio" checked value="1" <?php
                                    if ((isset($result)) && ($result["include_salary"] == 1)) {
                                        echo "checked";
                                    }
                                    ?> name="include_salary"><?php echo $this->lang->line('yes'); ?>
                                </label>
                                    <label class="radio-inline">
                                        <input type="radio" value="0" <?php
                                        if ((isset($result)) && ($result["include_salary"] == 0)) {
                                            echo "checked";
                                        }
                                        ?> name="include_salary"><?php echo $this->lang->line('no'); ?>
                                    </label>
