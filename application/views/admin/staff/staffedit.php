...
<?php } ?>     
												...
												<?php }
                                                if ($sch_setting->staff_tax) { ?>
                                                    <div class="col-md-4">
                                                        <div class="form-group">

                                                            <label for="exampleInputEmail1"><?php echo $this->lang->line('staff_tax'); ?></label>
                                                            <input id="staff_tax" name="staff_tax" placeholder="" type="text" class="form-control"  value="<?php echo $staff["tax"] ?>" />
                                                            <span class="text-danger"><?php echo form_error('staff_tax'); ?></span>
                                                        </div>
                                                    </div>
                                                <?php }
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <select name="payment_mode" id="payment_mode"  class="form-control">
                                                        ...
                                                        foreach ($payment_mode as $pkey => $pvalue) {
                                                            ?>
                                                            <option value="<?php echo $pkey ?>" <?php if($pkey==$staff["payment_mode"])echo "selected"?>><?php echo $pvalue ?></option>
                                                            <?php
                                                        }
                                                        ?>
