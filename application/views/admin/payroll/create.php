                                        ...
                                        <div class="feebox">
                                            <table class="table3" id="tableID">
                                                <tr id="row0">
                                                    ...
                                                    <td><input type="text" id="allowance_amount" name="allowance_amount[]" class="form-control" onkeyup="add_allowance()" value="0"></td>
                                        ...
                                        <div class="feebox">
                                            <table class="table3" id="tableID2">
                                                <tr id="deduction_row0">
                                                    ...
                                                    <td><input type="text" id="deduction_amount" name="deduction_amount[]" class="form-control" onkeyup="add_allowance()" value="0"></td>
                                ...
                                <div class="col-md-4 col-sm-4">
                                    ...
                                    <div class="sameheight">
                                        <div class="payrollbox feebox">
                                            ...
                                            {
                                                $oneDayAmount= $result["basic_salary"]/$days;
                                            ...
                                            if(!empty($currentmonthAttendance))
                                            {
                                                foreach ($currentmonthAttendance as $item)
                                                {
...
//                                            $netsalary=round($totalPresents*$oneDayAmount+$totalholidays*$oneDayAmount+$totalLateamount+$totalHalfdayAmount+$WithSalaryLeaves*$oneDayAmount);
                                            ...
                                            ?>
<!--                                            <div class="form-group">-->
<!--                                                <label class="col-sm-4 control-label">This Month Salary</label>-->
<!--                                                <div class="col-sm-8">-->
                                                    <input class="form-control" name="month_salary" id="month_salary" value="<?=$netsalary?>" readonly type="hidden" />
<!--                                                </div>-->
<!--                                            </div><!--./form-group-->
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8 deductiondred">
                                                    <input class="form-control" name="tax" id="tax" value="<?=$result["tax"]?>" type="text" />
                                                </div>
                                            </div><!--./form-group-->
...
<script type="text/javascript">
    ...
    function add_allowance() {
        ...
        var month_salary = $("#month_salary").val();
...
//total_deduction += parseInt(leave_deduction) ;
        ...
        var gross_salary = parseInt(month_salary) + parseInt(total_allowance) - parseInt(total_deduction);

        var net_salary = parseInt(month_salary) + parseInt(total_allowance) - parseInt(total_deduction) - parseInt(tax);
