                            ...
                            <div class="form-group">
                                ...
                                <select autofocus="" id="class_id" name="class_id" class="form-control" >
                                    ...
                                    foreach ($classlist as $class) {
                                        ?>
                                        <option value="<?php echo $class['id'] ?>"><?php echo $class['class'];if($class['school_id']==1){ echo "("."Pre-Primary".")";} if($class['school_id']==2){echo "("."Primary & Secondary ".")";} ?></option>
                                        <?php
                                        $count++;
                                    }
                                    ?>
...
foreach ($subjectlist as $subject) {
    ?>
            row += '<option value="<?php echo $subject['id'] ?>"><?php echo $subject['name'] . " (" . $subject['type'] . ")";echo ($subject['school_id']== 2) ? "(Primary & Secondary)" : "(Pre-Primary)";  ?></option>';
    <?php
    $count++;
}
?>
...
foreach ($subjectlist as $subject) {
    ?>
            ...
            row += '<option value="<?php echo $subject['id'] ?>" ' + selected + '><?php echo $subject['name'] . " (" . $subject['type'] . ")";echo ($subject['school_id']== 2) ? "(Primary & Secondary)" : "(Pre-Primary)";  ?></option>';
