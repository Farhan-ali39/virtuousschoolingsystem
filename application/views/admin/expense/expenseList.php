                                ...
                                <div class="form-group">
                                    <label for="inputPassword3" class="col-sm-3 control-label"><?php echo $this->lang->line('payment'); ?> <?php echo $this->lang->line('mode'); ?></label>
                                        ...
                                        <label class="radio-inline">
                                            <input type="radio" name="payment_mode_expenses" value="Cash" checked="checked"><?php echo $this->lang->line('cash'); ?> </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="payment_mode_expenses" value="Cheque">  SONERI</label>
                                        <label class="radio-inline">
                                            <input type="radio" name="payment_mode_expenses" value="DD">HBL
                                        </label>
