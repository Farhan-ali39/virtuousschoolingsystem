                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="radio-inline">
                                        <input type="radio" name="payment_mode_expenses" value="Cash" <?=($expense['payment_mode']=='Cash')?"checked='checked'":""?> ><?php echo $this->lang->line('cash'); ?> </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="payment_mode_expenses" value="Cheque" <?=($expense['payment_mode']=='Cheque')?"checked='checked'":""?>> SONERI</label>
                                    <label class="radio-inline">
                                        <input type="radio" name="payment_mode_expenses" value="DD" <?=($expense['payment_mode']=='DD')?"checked='checked'":""?>>HBL
                                    </label>
