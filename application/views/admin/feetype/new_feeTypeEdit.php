            ...
            if ($this->rbac->hasPrivilege('fees_type', 'can_add') || $this->rbac->hasPrivilege('fees_type', 'can_edit')) {
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        ...
                        <form action="<?php echo site_url("studentfee/editFeeType/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="code" name="amount" type="text" class="form-control"  value="<?php echo set_value('code', $feetype['amount']); ?>" />
                                    <span class="text-danger"><?php echo form_error('amount'); ?></span>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <label>Fee Type<small class="req"> *</small>&nbsp;&nbsp;&nbsp;</label>
                                        <label class="radio-inline">
                                            <input type="radio" name="fee_type" <?php
                                            echo set_value('fee_type',$feetype['fee_type']) == "tuition" ? "checked" : "";
                                            ?>   value="tuition"> Tuition
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="fee_type" <?php
                                            echo set_value('fee_type',$feetype['fee_type']) == "other" ? "checked" : "";
                                            ?>   value="other">Other
                                        </label>
                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                ...
                                foreach ($feetypeList as $feetype) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="mailbox-name">
                                            <?php echo number_format($feetype['amount']); ?>
                                        </td>
                                        ...
                                        <td class="mailbox-date pull-right">
                                            ...
                                            if ($this->rbac->hasPrivilege('fees_type', 'can_edit')) {
                                                ?>
                                                <a data-placement="left" href="<?php echo base_url(); ?>studentfee/editFeeType/<?php echo $feetype['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                            ...
                                            if ($this->rbac->hasPrivilege('fees_type', 'can_delete')) {
                                                ?>
                                                <a data-placement="left" href="<?php echo base_url(); ?>studentfee/deleteFeeType/<?php echo $feetype['id'] ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
