...
<!--                                            $subjectArray=[$value['subject_id']]-->
                                                ...
                                                foreach ($examSchedule as $key => $value) {
                                                    ...
                                                    if(in_array($value['subject_id'],$subjectArray))
                                                    {

                                                        ?>
                                                        <input type="hidden" name="i_<?=$value['subject_id']?>[]" value="<?php echo $value['id'] ?>">
                                                        <?php
                                                    }else
                                                    {
                                                        $subjectArray=[$value['subject_id']]
                                                        ?>
                                                        <input type="hidden" name="i_<?=$value['subject_id']?>[]" value="<?php echo $value['id'] ?>">
                                                        <input type="hidden" name="subjectIds[]" value="<?php echo $value['subject_id'] ?>">
                                                        <tr>
                                                            <td>
                                                                <div class="form-group">

                                                                    <?php echo $value['name'] . " (" . substr($value['type'], 0, 2) . ".)"; echo ($value['school_id']== 2) ? "(P & S)" : "(Pre-P)"; ?>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <?php
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="date_<?php echo $value['subject_id'] ?>" class="form-control sandbox-container" id="date_<?php echo $value['subject_id'] ?>" placeholder="Enter date" value="<?php echo $exam_date; ?>">
                                                                </div>
                                                            </td>
                                                                ...
                                                                <div class="bootstrap-timepicker">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">
                                                                            <input type="text" name="stime_<?php echo $value['subject_id'] ?>" class="form-control timepicker" id="stime_<?php echo $value['subject_id'] ?>" value="<?php echo $exam_time; ?>">
                                                            ...
                                                            <td style="width:200px;">
                                                                <div class="bootstrap-timepicker">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">
                                                                            <input type="text" name="etime_<?php echo $value['subject_id'] ?>" class="form-control timepicker" id="etime_<?php echo $value['subject_id'] ?>" value="<?php echo $value['end_from'] ?>">
                                                                            <div class="input-group-addon">
                                                                                <i class="fa fa-clock-o"></i>
                                                                            </div>
                                                                        </div><!-- /.input group -->
                                                            ...
                                                            <td>
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="room_<?php echo $value['subject_id'] ?>" class="form-control"  id="room_<?php echo $value['subject_id'] ?>" value="<?php echo $value['room_no'] ?>" placeholder="Enter Room">
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-group">

                                                                    <input type="text" name="fmark_<?php echo $value['subject_id'] ?>" class="form-control" id="fmark_<?php echo $value['subject_id'] ?>" value="<?php echo $value['full_marks'] ?>" placeholder="Enter Full Marks">
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-group">

                                                                    <input type="text" name="pmarks_<?php echo $value['subject_id'] ?>" class="form-control" id="pmarks_<?php echo $value['subject_id'] ?>" value="<?php echo $value['passing_marks'] ?>" placeholder="Enter Passing Marks">
                                                                </div>
                                                            </td>
                                                        </tr>
