...
<!--                            <li class="col-lg-4 col-md-4 col-sm-6 --><?php //echo set_SubSubmenu('Reports/finance/collection_report'); ?><!--"><a href="--><?php //echo base_url(); ?><!--studentfee/collection_report"><i class="fa fa-file-text-o"></i> --><?php //echo $this->lang->line('fees')." ".$this->lang->line('collection')." ".$this->lang->line('report'); ?><!--</a></li>-->
                            <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/finance/collection_report'); ?>"><a href="<?php echo base_url(); ?>studentfee/feeCollection_report"><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('fees')." ".$this->lang->line('collection')." ".$this->lang->line('report'); ?></a></li>
                        <?php } if ($this->rbac->hasPrivilege('fees_collection_report', 'can_view')) {

                            ?>

                             <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/finance/reconciliation_report_search'); ?>"><a href="<?php echo base_url(); ?>studentfee/reconciliation_report_search"><i class="fa fa-file-text-o"></i> Reconciliation Report</a></li>
                        <?php } if ($this->rbac->hasPrivilege('fees_collection_report', 'can_view')) {

                            ?>
                             <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/finance/feeRegister'); ?>"><a href="<?php echo base_url(); ?>studentfee/feeRegister"><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('fees')." "."Register"; ?></a></li>
