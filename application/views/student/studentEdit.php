                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="fee_case">
                                                    <option value="1" <?=($student['std_fee_case']==1)?"selected":""?> >Monthly</option>
                                                    <option value="2" <?=($student['std_fee_case']==2)?"selected":""?>>Bi-Monthly</option>
                                         ...
                                         <div class="col-md-3 col-xs-12">
                                             <div class="form-group">
                                                 <label for="exampleInputEmail1">Tuition Fee</label>
                                                 <input type="text" id="tutionFee"   value="<?=set_value('tutionFee',$tutionFee->std_tuition_fee)?>" name="tutionFee" class="form-control ">
                                                 <span class="text-danger"><?php echo form_error('tutionFee'); ?></span>
                                             </div>
                                        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#fees_discount').keyup(function(){

            var totalfee=parseInt( countTotalFee('para1'));
...
//            $.ajax({
//                url:"<?php //echo base_url('mobile/searchItembyPartno')?>//",
//                method:"POST",
//                data:{
...
//                    $("#stockInHand").val(response.qty);
//                    $("#item_id").val(response.item_id);
//                    $("#part_no_2").val(response.part_no_2);
//                    $("#qty_number").attr({
//                        "max" : response.qty,
//                    });
//                }
