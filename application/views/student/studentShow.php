...
//5235
                            ...
                            if ($this->rbac->hasPrivilege('student', 'can_edit')) {
                                ...
                                <li class="pull-right">
                                    <a href="<?php echo base_url() . "student/delete/" . $student["id"] ?>"  class="" data-toggle="tooltip" data-placement="bottom" title="<?php echo $this->lang->line('delete'); ?>"><i class="fa fa-trash"></i>
                                        <?php //echo $this->lang->line('login_details');    ?>
                                    </a>
                                </li>
                                <?php
