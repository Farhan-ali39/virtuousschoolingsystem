                    ...
                    <form id="form1" action="<?php echo site_url('student/create') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        ...
                        <div class="">
                                        ...
                                        <?php if (!$adm_auto_insert) {  ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input autofocus="" id="admission_no" name="admission_no" placeholder="" type="text" class="form-control"  value="<?php echo $roll_no; ?>"  readonly />
                                        ...
                                        <?php if ($sch_setting->roll_no) {  ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="roll_no" name="roll_no" placeholder="" type="text" class="form-control"  value="<?php echo $roll_no; ?>"  readonly />
                            ...
                            <div class="box-footer">
                                <button type="submit" value="save" name="btn_save" class="btn btn-info pull-right"><?php echo $this->lang->line('save'); ?></button>
                            </div>
                    </form>
                </div>
            </div>
