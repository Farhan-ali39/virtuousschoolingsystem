...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
             <div class="col-md-12">
                 <input type="hidden" value="<?=(isset($class_id))?$class_id:""?>" id="class_id_input">
                 <input type="hidden" value="<?=(isset($section_id))?$section_id:""?>" id="section_id_input">
...
<script type="text/javascript">
    ...
    function load(page) {
        ...
        var section_id = $('#section_id_input').val();
        var class_id = $('#class_id_input').val();
        var is_gallery = 0;
        $.ajax({
            url: "<?php echo base_url(); ?>user/media/getRecordedClasses/" + page,
            method: "GET",
            data: {
                'keyword': keyword, 'file_type': file_type, 'is_gallery': is_gallery, 'section_id': section_id, 'class_id': class_id
            },
            dataType: "json",
            beforeSend: function () {
                $('#media_div').empty();
