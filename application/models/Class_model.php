...
class Class_model extends MY_Model
{
    ...
    public function get($id = null, $classteacher = null,$school_id=null)
    {
...
//                $school_id = 1 means primary
//                $school_id = 2 means primary and secondry
    ...
    public function getSubjectExtras($subject_id)
    {
        return $this->db->get_where("subjects", array("id" => $subject_id))->row()->extra_assessment;
    }
    public function addSubjectExtras($grades,$subject_id,$student_id)
    {
        ...
        if ($q->num_rows() > 0) {
            ...
            $this->db->update('pre_primary_extra_grade',$grades);
        } else {
            $this->db->insert('pre_primary_extra_grade', $grades);
    ...
    public function getSubjectExtragrades($subject_id,$student_id)
    {
        $this->db->where('student_id', $student_id);
        $this->db->where('subject_id', $subject_id);
        $q = $this->db->get('pre_primary_extra_grade');
